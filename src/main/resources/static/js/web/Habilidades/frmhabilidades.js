...
$(document).on("click", "#btnguardar", function(){
	$.ajax({
		type: "POST",
		url: "/habilidad/registrarHabilidad",
...
$(document).on("click", "#btneliminar", function(){
	$.ajax({
		type: "DELETE",
		contentType: 'application/json',
		url: "/habilidad/eliminarHabilidad",
		data: JSON.stringify({
...
function ListarHabilidad(){
	$.ajax({
		type: "GET",
		url: "/habilidad/listarHabilidades",
		dataType: "json",
		success: function(resultado){
			$("#tblhabilidad > tbody").html("");
			$.each(resultado, function(index, value){
				$("#tblhabilidad > tbody").append("<tr>"+
						...
						"<td>"+
							"<button type='button' class='btn btn-danger btneliminahHabilidad'"+	
							" data-id_habilidad='"+value.id_habilidad+"'"+
							" data-habilidad='"+value.habilidad+"'"+
